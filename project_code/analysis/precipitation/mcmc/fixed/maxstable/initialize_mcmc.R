...
it <- 1                                     # Chunk number
alpha <- 0.7                                # Positive stable index
...
mar_betas <- list(loc = 1, scale = 0.7, shape = 0) # Linear coefs for GEV parameters
...
zall <- rstabmix(                            # Used to get initial values                
  n,
  obs_coords,
