...
csims <-
  lnorm_cond_sim_all(out,                                          # mcmc posterior predictive samples              
...
dir.create(file.path(samples.dir, "holdout"),
           showWarnings = FALSE,
           recursive = TRUE)
save(csims, file = file.path(samples.dir, "holdout", 
                             paste0(stub, "_holdout_latent.Rdata")))

# Extract latent variables
load(file.path(samples.dir, paste0(stub, ".Rdata")))
load(file.path(samples.dir, "holdout", paste0(stub, "_holdout_latent.Rdata")))
...
# Save output -------------------------------------------------------------
save(lscores, file = file.path(samples.dir, "holdout",
                               paste0(stub, "_lscores.Rdata")))
